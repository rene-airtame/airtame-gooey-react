...
describe('<RadioGroup />', () => {
  it('should render the radio button group', () => {
    ...
    const wrapper = shallow(<RadioGroup name="test-radio" data={radios} active="foo" />);
  ...
  it('should make the first radio checked by default', () => {
    ...
    const wrapper = render(<RadioGroup name="test-radio" data={radios} />);
  ...
  it('should make the requested radio checked', () => {
    ...
    const wrapper = render(<RadioGroup name="test-radio" data={radios} active="bar" />);
  ...
  it('should disable individual radios', () => {
    ...
    const wrapper = render(<RadioGroup name="test-radio" data={radios} active="foo" />);
  ...
  it('should disable all radios', () => {
    ...
    const wrapper = render(<RadioGroup name="test-radio" data={radios} active="foo" isDisabled />);
  ...
  it('should properly set refs for the radios', () => {
    ...
    const wrapper = mount(<RadioGroup name="test-radio" data={radios} active="foo" />);
  ...
  it('should set the proper state if the data prop is updated', () => {
    ...
    const wrapper = shallow(<RadioGroup name="test-radio" data={radios} />);
    expect(wrapper.state('active')).toEqual('foo');
  ...
  it('should not touch the state if the data prop doesnt change', () => {
    ...
    const wrapper = shallow(<RadioGroup name="test-radio" data={radios} active="bar" />);
    expect(wrapper.state('active')).toEqual('bar');
    wrapper.setProps({ data: radios2 });
    expect(wrapper.state('active')).toEqual('bar');
  });
